...
REGISTRY_NAME="gnosis-get-convos-registry"
IMAGE_NAME="gnosis/get-convos"
INSTANCE_ID="i-0a9caf95434207ee9"
INSTANCE_PUBLIC_IP=$(cat ../secrets.json | jq -r '.["gnosis-convos"].CONVERSATION_API_URL' | cut -d'/' -f3 | cut -d':' -f1)
